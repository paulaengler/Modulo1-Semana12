...
cursoRoutes.post('/cursos', auth,  async (req, res) => {
    try {
...
cursoRoutes.get('/cursos', auth,  async (req, res) => {
    try {
        let params = {}
...
cursoRoutes.delete('/cursos/:id', auth, (req, res) => {
    const { id } = req.params
...
cursoRoutes.put('/cursos/:id', auth, async (req, res) => {
    const { id } = req.params
